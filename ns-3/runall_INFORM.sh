        ...
        do
			...
			let "realReq = $simDuration * $z"
                        ...
                        do
                                ...
                                /usr/bin/time -f "\n%E \t elapsed real time \n%U \t total CPU seconds used (user mode) \n%S \t total CPU seconds used by the system on behalf of the process \n%M \t memory (max resident set size) [kBytes] \n%x \t exit status" -o ${infoDir}/Info_SIM\=${fws}_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}_R\=${i}.txt $main --run "scratch/ndn-inform --uniqueContents\=${M} --contentCatalogFib\=${estM} --cacheToCatalog\=${C} --lambda\=${z} --alpha\=${k} --clientPerc\=${clPerc} --eta\=${eta} --delta\=${delta} --maxChunkExplorPhase\=${maxExplor} --maxChunkExploitPhase\=${maxExploit} --qTabEntryLifetime\=${qTabLifetime} --networkType\=${n} --topologyImport\=${netImport} --simDuration\=${simDuration} --RngSeed\=1 --RngRun\=${j}" > $logDir/stdout/logSIM\=${fws}_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}_R\=${i}.out 2>&1

                        done

                        tar -zcvf $logDir/compressed/log_S\=${fws}_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}.tar.gz $logDir/${fws}/DATA/Data*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/DATA/APP/Data*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/INTEREST/Interest*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/INTEREST/APP/Interest*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/DOWNLOAD/APP/Download*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}*

                        rm $logDir/${fws}/DATA/Data*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/DATA/APP/Data*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/INTEREST/Interest*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/INTEREST/APP/Interest*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}* $logDir/${fws}/DOWNLOAD/APP/Download*_N\=${n}_eta\=${eta}_delta\=${delta}_chunkExplor\=${maxExplor}_chunkExploit\=${maxExploit}_qTabLife\=${qTabLifitime}_A\=${k}*
