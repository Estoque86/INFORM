  ...
  , m_needSetDefaultRoutes (false)
{
  ...
  m_qtabFactory.		SetTypeId ("ns3::ndn::qtab::Persistent");
...
void
StackHelper::SetQtab (const std::string &qtabClass,
                     const std::string &attr1, const std::string &value1,
                     const std::string &attr2, const std::string &value2,
                     const std::string &attr3, const std::string &value3,
                     const std::string &attr4, const std::string &value4)
{
  m_qtabFactory.SetTypeId (qtabClass);
  if (attr1 != "")
      m_qtabFactory.Set (attr1, StringValue (value1));
  if (attr2 != "")
      m_qtabFactory.Set (attr2, StringValue (value2));
  if (attr3 != "")
      m_qtabFactory.Set (attr3, StringValue (value3));
  if (attr4 != "")
      m_qtabFactory.Set (attr4, StringValue (value4));
}
...
StackHelper::Install (Ptr<Node> node) const
{
  ...
  // ** [MT] ** Create and aggregate QTAB
  ndn->AggregateObject (m_qtabFactory.Create<Qtab> ());
