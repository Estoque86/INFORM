...
#include "/media/DATI/tortelli/INFORM/ns-3/src/ndnSIM/model/repo/ndn-repo.h"
...
protected:
  ...
  bool
  SendOutInterestInform (Ptr<Face> inFace,
                      Ptr<Face> outFace,
                      Ptr<const Interest> header,
                      Ptr<const Packet> origPacket,
                      Ptr<pit::Entry> pitEntry);
  ...
  void
  PropagateInterestQtab (Ptr<Face> inFace,
                     Ptr<const Interest> header,
                     Ptr<const Packet> origPacket,
                     Ptr<pit::Entry> pitEntry,
  ...
  virtual bool
  DoPropagateInterestQtab (Ptr<Face> inFace,
                       Ptr<const Interest> header,
                       Ptr<const Packet> origPacket,
                       Ptr<pit::Entry> pitEntry,
                       Ptr<qtab::Entry> qtabEntry) = 0;
...
protected:
  ...
  Ptr<UniformRandomVariable> myRand;
